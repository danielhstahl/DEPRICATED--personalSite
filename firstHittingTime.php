<html>
    ...
    <div class='jumbotron navbar-fixed-top' >
        <!--<div class='col-xs-8 col-xs-offset-2 title'>-->        <div class='container title'>
            The Density of the First Hitting Time
        </div>
    </div>
    ...
    <div > <!--used to have a container here -->
        <div class='col-xs-8 col-xs-offset-2'>             <div class='txt'>                This page describes how to numerically compute the density of the first hitting time of a CEV process.  See <?php include 'assets/includes/scrapeSimilar.php'; ?> for the application that displays this density.            </div>
            ...
            <div class='title'>Characteristic functions explained</div>             <div class='txt'>
            ...
            <div class='title'>First Hitting Time </div>            <div class='txt'>
            ...
            <div class='subTitle'>Dynkan's Formula</div>            <div class='txt'>
            ...
            <div class='subTitle'>Finding the Characteristic Function of \(\tau\)</div>            <div class='txt'>
